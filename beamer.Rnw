...
\begin{itemize}
  ...
  \includegraphics[width=0.45\textwidth]{perceptron.jpg}%
  \includegraphics[width=0.25\textwidth]{perceptron2.jpg}
\end{itemize}
\end{frame}
...
\begin{itemize}
  \item LondonR - \includegraphics[width=0.2\textwidth]{londonr.PNG}
  \item ManchesterR - \includegraphics[width=0.2\textwidth]{manchesterr.png}
  \item CaRdiff - \includegraphics[width=0.2\textwidth]{cardiff.JPG}
  \item SheffieldR
  \item EdinbR - \includegraphics[width=0.2\textwidth]{edinbr.PNG}
  \item CambR - \includegraphics[width=0.1\textwidth]{cambr.JPG}
  \item NottinghamR
  \item BirminghamR - \includegraphics[width=0.1\textwidth]{birminghamr.JPG}
  \item Oxford RUG - \includegraphics[width=0.1\textwidth]{oxfordrug.PNG}
  \item Bristol Data Scientists - \includegraphics[width=0.2\textwidth]{bristolds.JPG}
\end{itemize}
\end{frame}
...
\begin{frame} {International User Communities}
  \begin{itemize}
    ...
    \includegraphics[width=0.2\textwidth]{userconf.PNG}
    
    \item Enterprise Application of the R Language (EARL) \\
    \includegraphics[width=0.2\textwidth]{earlconf.PNG}
    
    \item European R User Meeting (ERUM) \\
    \includegraphics[width=0.2\textwidth]{erumconf.JPG}
