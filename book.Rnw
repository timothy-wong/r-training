...
myFactor <- factor(c(1, 3, 3, 2, 2, 1, 2, 3),
                   levels = c(1, 2, 3),
...
\begin{enumerate}
  ...
  \item Compare a new variable \verb|air_time| as \verb|arr_time - dep_time|. What do you expect to see? What problem do you see? What do you need to do to fix it?
